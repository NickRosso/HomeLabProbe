...
Loads the configured services in homelab_services.json and makes requests to each of the endpoints. Customizable to services on your network with /health probe endpoints.

Example response
{
  "vaultwarden": "\"2026-02-22T03:52:01.260343Z\"",
  "traefik": "401 Unauthorized\n",
  "Ubiquit Dream Machine SE": "{\"meta\":{\"rc\":\"ok\"},\"data\":[{\"subsystem\":\"wlan\",\"num_user\":13 ...}]}"
}
